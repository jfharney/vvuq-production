...
private static String USER_NAME = "jfharney";  // GMail user name (just the part before "@gmail.com")
private static String PASSWORD = "1Ring2Rule"; // GMail password
private static String RECIPIENT = "harneyjf@ornl.gov";
